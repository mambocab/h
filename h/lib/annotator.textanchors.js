...
(function() {
  ...
  Annotator.Plugin.TextAnchors = (function(_super) {
    ...
    TextAnchors.prototype.checkForEndSelection = function(event) {
      ...
      if (selectedRanges.length) {
        ...
        for (_j = 0, _len1 = selectedRanges.length; _j < _len1; _j++) {
          r = selectedRanges[_j];
          event.targets.push(this.annotator.getTargetFromSelection({
            type: "text range",
            range: r
          }));
        }
    ...
    TextAnchors.prototype._getRangeSelector = function(selection) {
      var sr;
    ...
    TextAnchors.prototype._getTextQuoteSelector = function(selection) {
      ...
      return [
        this.useDTM ? (startOffset = (this.annotator.domMapper.getInfoForNode(rangeStart)).start, endOffset = (this.annotator.domMapper.getInfoForNode(rangeEnd)).end, quote = this.annotator.domMapper.getCorpus().slice(startOffset, +(endOffset - 1) + 1 || 9e9).trim(), (_ref1 = this.annotator.domMapper.getContextForCharRange(startOffset, endOffset), prefix = _ref1[0], suffix = _ref1[1], _ref1), {
    ...
    TextAnchors.prototype._getTextPositionSelector = function(selection) {
