...
(function() {
  ...
  Annotator.Plugin.TextAnchors = (function(_super) {
    ...
    TextAnchors.prototype.isThisSupposedToBeAnnotated = function(node) {
      ...
      while (goOn) {
        goOn = false;
        _ref1 = this.annotator.anchoring._highlighters;
    ...
    TextAnchors.prototype.checkForEndSelection = function(event) {
      var launch, pos, r, range, selectedRanges, _base, _i, _len,
        _this = this;
      if (event == null) {
        event = {};
      }
      ...
      if (typeof (_base = this.annotator).initAnchoring === "function") {
        _base.initAnchoring();
      }
