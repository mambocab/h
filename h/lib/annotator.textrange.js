    ...
    TextRange.prototype._createFromRangeSelector = function(annotation, target) {
      ...
      if (this.annotator.plugins.TextPosition) {
        this.annotator.domMapper.prepare("anchoring").then(function(s) {
          ...
          return dfd.resolve(new _this.Annotator.TextPositionAnchor(_this.annotator, annotation, target, startInfo.start, endInfo.end, (_ref1 = startInfo.pageIndex) != null ? _ref1 : 0, (_ref2 = endInfo.pageIndex) != null ? _ref2 : 0, currentQuote));
        });
      } else {
