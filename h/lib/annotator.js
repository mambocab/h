...
(function() {
  ...
  Anchor = (function() {
    function Anchor(annotator, annotation, target, type, startPage, endPage, quote, diffHTML, diffCaseOnly) {
      ...
      if (this.annotator == null) {
        throw new Error("annotator is required!");
      }
      ...
      if (this.startPage == null) {
        new Error("startPage is required!");
      }
      if (this.endPage == null) {
        throw new Error("endPage is required!");
      }
      if (this.quote == null) {
    ...
    Anchor.prototype.realize = function() {
      ...
      created = (function() {
        ...
        for (_l = 0, _len2 = pagesTodo.length; _l < _len2; _l++) {
          page = pagesTodo[_l];
          _results1.push(this.highlight[page] = this.annotator._createHighlight(this, page));
        }
        return _results1;
      }).call(this);
  ...
  Annotator = (function(_super) {
    ...
    function Annotator(element, options) {
      ...
      this.getTargetFromSelection = __bind(this.getTargetFromSelection, this);
    ...
    Annotator.prototype.getTargetFromSelection = function(selection) {
