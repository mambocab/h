...
(function() {
  ...
  Highlight = (function() {
    function Highlight(annotator, anchor, pageIndex) {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._realizeAnchor = function(anchor) {
      ...
      created = (function() {
        ...
        for (_l = 0, _len2 = pagesTodo.length; _l < _len2; _l++) {
          page = pagesTodo[_l];
          _results1.push(anchor.highlight[page] = this._createHighlight(anchor, page));
        }
        return _results1;
      }).call(this);
      anchor.fullyRealized = renderedPages.length === anchor.endPage - anchor.startPage + 1;
      return this.publish('highlightsCreated', created);
    };
    ...
    Annotator.prototype._virtualizeAnchor = function(anchor, pageIndex) {
      ...
      return this.publish('highlightRemoved', highlight);
    };
    ...
    Annotator.prototype._createHighlight = function(anchor, page) {
      var h, result, _k, _len2, _ref1;
      _ref1 = this.highlighters;
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        h = _ref1[_k];
    ...
    Annotator.prototype._realizePage = function(index) {
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        anchor = _ref2[_k];
        _results.push(this._realizeAnchor(anchor));
      }
      return _results;
    };
    ...
    Annotator.prototype._virtualizePage = function(index) {
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        anchor = _ref2[_k];
        _results.push(this._virtualizeAnchor(anchor, index));
      }
      return _results;
    };
