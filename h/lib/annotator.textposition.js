...
(function() {
  ...
  TextPositionAnchor = (function(_super) {
    ...
    function TextPositionAnchor(annotator, annotation, target, start, end, startPage, endPage, quote, diffHTML, diffCaseOnly) {
      this.start = start;
      this.end = end;
      TextPositionAnchor.__super__.constructor.call(this, annotator, annotation, target, "text position", startPage, endPage, quote, diffHTML, diffCaseOnly);
      if (this.start == null) {
