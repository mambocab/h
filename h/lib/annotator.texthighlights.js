...
(function() {
  ...
  Annotator.Plugin.TextHighlights = (function(_super) {
    ...
    TextHighlights.prototype.pluginInit = function() {
      ...
      this.$ = Annotator.$;
      return this.annotator.highlighters.push({
    ...
    TextHighlights.prototype._createTextHighlight = function(anchor, page) {
      ...
      switch (anchor.type) {
        case "text range":
          return new TextHighlight(anchor, page, anchor.range);
        case "text position":
          if (this.annotator.domMapper != null) {
            ...
            return new TextHighlight(anchor, page, normedRange);
          } else {
            return null;
          }
          break;
