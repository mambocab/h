...
(function() {
  ...
  TextHighlight = (function(_super) {
    ...
    function TextHighlight(annotator, anchor, pageIndex, normedRange) {
      TextHighlight.__super__.constructor.call(this, annotator, anchor, pageIndex);
      this.$ = TextHighlight.$;
  ...
  Annotator.Plugin.TextHighlights = (function(_super) {
    ...
    function TextHighlights() {
      this._getIndependentParent = __bind(this._getIndependentParent, this);
      this._isInstance = __bind(this._isInstance, this);
    ...
    TextHighlights.prototype.pluginInit = function() {
      ...
      this.$ = Annotator.$;
      this.annotator.highlighters.push({
    ...
    TextHighlights.prototype._createTextHighlight = function(anchor, page) {
      ...
      switch (anchor.type) {
        case "text range":
          return new TextHighlight(this.annotator, anchor, page, anchor.range);
        case "text position":
          if (this.annotator.domMapper != null) {
            mappings = this.annotator.domMapper.getMappingsForCharRange(anchor.start, anchor.end, [page]);
            ...
            return new TextHighlight(this.annotator, anchor, page, normedRange);
          } else {
            return null;
          }
          break;
    ...
    TextHighlights.prototype._isInstance = function(element) {
      return this.$(element).hasClass('annotator-hl');
    };

    TextHighlights.prototype._getIndependentParent = function(element) {
